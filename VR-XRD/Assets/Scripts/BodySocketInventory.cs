...
public class BodySocketInventory : MonoBehaviour
{
    ...
    {
        var position = bodySocket.gameObject.transform.position;
        position = new Vector3(position.x, _CurrentHMDPosition.y * bodySocket.heightRatio, position.z);
        bodySocket.gameObject.transform.position = position;
    }
